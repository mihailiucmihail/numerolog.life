...
function calcFlow(){
  ...
  box.innerHTML = gtext(`
    ...
    <div class="card">
      ...
      <p class="body-txt" style="margin-top:14px;">Китайский год = григорианский + 2698, отсчёт года начинается не 1 января, а от китайского Нового года. Перевод дат сверен по таблицам с 1930 по 2030 год.</p>
    </div>
    ${crystalBlock()}
    `, who.gender);
}
