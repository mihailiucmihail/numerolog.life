...
const COPY: Record<Locale, Copy> = {
  ro: {
    nav: ['Metodă', 'În raport', 'Despre Daria'], eyebrow: 'Produsul-fanion NUMEROLOG.life',
  ...
  ru: {
    nav: ['Метод', 'Что внутри', 'О Дарье'], eyebrow: 'Главный продукт NUMEROLOG.life',
    ...
    faqs: [
      ...
      { q: 'Это нумерология или астрология?', a: 'Кристалл — нумерологический инструмент на системе 22 Арканов. Время и место рождения не исп��льзуются.' },
