...
export function NewsletterPopup() {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="nl-popup-title" className="fixed inset-0 z-[60] flex items-end justify-center bg-black/70 p-4 backdrop-blur-sm sm:items-center" onClick={dismiss}>
      <div className="glass-warm relative w-full max-w-md overflow-y-auto rounded-2xl border border-primary/25 p-6 sm:p-8" onClick={(e) => e.stopPropagation()}>
