...
export function NewsletterPopup() {
  ...
  if (!open) return null
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="nl-popup-title" className="fixed inset-0 z-[60] flex items-center justify-center bg-background/35 p-4 backdrop-blur-[3px]" onClick={dismiss}>
