 ...
 window.removeEventListener("message", onMessage)
  ...
  return (
    <div className="relative"
      ...
      {loading && <div className="absolute inset-0 z-10 grid place-items-center bg-background/80 text-sm text-foreground"
Se pregătește plata…</div
}
      {error && <p role="alert" className="mb-3 text-center text-sm text-destructive"
{error}</p
}
