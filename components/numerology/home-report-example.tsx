      ...
      <div className="mx-auto max-w-[1120px]">
        ...
        <nav ref={toolbarRef} id="prima-cheie" aria-label={ro ? 'Navigare raport și calcul personal' : 'Разделы и личный расчёт'} className="sticky top-[env(safe-area-inset-top,0px)] z-30 scroll-mt-0 border border-primary/20 bg-card/95 p-2 text-foreground shadow-lg backdrop-blur-xl sm:rounded-b-xl">
          <div className="flex flex-wrap items-center gap-2">
            <span className="order-last basis-full px-2 pt-1 text-xs font-semibold leading-4 text-foreground/85 sm:text-sm sm:leading-5">{ro ? 'Raport exemplu · Pentru raportul tău, apasă butonul galben și completează datele personale.' : 'Пример разбора · Для своего разбора нажми жёлтую кнопку и введи личные данные.'}</span>
