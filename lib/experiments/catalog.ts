...
export const FORM_VARIANTS: VariantDef[] = [
  ...
  { id: 'form-career-dual-v1', kind: 'form', label: 'Carieră + Autorealizare (formular Career Future)', hypothesis: 'Același formular Career Future; diferă doar previzualizarea (două grafice reale).', angle: 'carieră: același formular', motion: 2, active: false, weight: 0 },
