...
export const FORM_VARIANTS: VariantDef[] = [
  ...
  { id: 'form-birthday-first', kind: 'form', label: 'Birthday First', hypothesis: 'Începerea cu data nașterii creează un angajament rapid înainte de cererea numelui.', angle: 'progressive profiling', motion: 2, active: true, weight: 9 },
  ...
  { id: 'form-career-graph', kind: 'form', label: 'Career Graph', hypothesis: 'O întrebare despre carieră urmată de graficul vocației crește intenția de cumpărare.', angle: 'carieră', motion: 2, active: true, weight: 9 },
  { id: 'form-life-now', kind: 'form', label: 'Life Now', hypothesis: 'Identificarea tensiunii actuale înainte de calcul face rezultatul imediat relevant.', angle: 'momentul prezent', motion: 2, active: true, weight: 9 },
  ...
  { id: 'form-relationship-needs', kind: 'form', label: 'Relationship Needs', hypothesis: 'Nevoia relațională calculată răspunde direct intenției și deschide întrebări apropiate.', angle: 'nevoi relaționale', motion: 2, active: true, weight: 9 },
  { id: 'form-life-timeline', kind: 'form', label: 'Life Timeline', hypothesis: 'Poziționarea pe etapa actuală a vieții transformă graficul într-o poveste personală.', angle: 'cronologia vieții', motion: 2, active: true, weight: 9 },
  { id: 'form-career-future-v1', kind: 'form', label: 'Career Future', hypothesis: 'Un rezultat profesional real obținut doar din data nașterii motivează completarea identității pentru următoarea etapă.', angle: 'viitor profesional', motion: 2, active: true, weight: 9 },
  { id: 'form-relationship-future-v1', kind: 'form', label: 'Relationship Future', hypothesis: 'Poziția relațională actuală creează suficientă relevanță pentru aprofundarea personală ulterioară.', angle: 'viitor relațional', motion: 2, active: true, weight: 9 },
  { id: 'form-money-future-v1', kind: 'form', label: 'Money Future', hypothesis: 'Direcția financiară actuală, calculată înaintea numelui, deschide natural întrebarea următorului prag.', angle: 'viitor financiar', motion: 2, active: true, weight: 9 },
...
export const PREVIEW_VARIANTS: VariantDef[] = [
  ...
  { id: 'preview-birthday-first', kind: 'preview', label: 'Birthday First', hypothesis: 'Cardul personal al datei de naștere validează instant calculul.', angle: 'identitate', motion: 2, active: true, weight: 9 },
  ...
  { id: 'preview-career-graph', kind: 'preview', label: 'Career Graph', hypothesis: 'Graficul carierei în prim-plan conectează calculul cu întrebarea vizitatorului.', angle: 'carieră', motion: 2, active: true, weight: 9 },
  { id: 'preview-life-now', kind: 'preview', label: 'Life Now', hypothesis: 'O singură concluzie despre etapa actuală păstrează claritatea și tensiunea narativă.', angle: 'momentul prezent', motion: 1, active: true, weight: 9 },
  ...
  { id: 'preview-relationship-needs', kind: 'preview', label: 'Relationship Needs', hypothesis: 'Răspunsul despre nevoia relațională deschide natural scenariile și perioadele complete.', angle: 'nevoi relaționale', motion: 2, active: true, weight: 9 },
  { id: 'preview-life-timeline', kind: 'preview', label: 'Life Timeline', hypothesis: 'Punctul actual vizibil și viitorul mascat maximizează curiozitatea fără promisiuni inventate.', angle: 'cronologia vieții', motion: 2, active: true, weight: 9 },
  { id: 'preview-career-future-v1', kind: 'preview', label: 'Career Future', hypothesis: 'Graficul carierei arată trecutul și punctul actual, păstrând următoarea schimbare pentru continuare.', angle: 'viitor profesional', motion: 2, active: true, weight: 9 },
  { id: 'preview-relationship-future-v1', kind: 'preview', label: 'Relationship Future', hypothesis: 'Graficul relațional oferă o concluzie prezentă reală fără a dezvălui următoarea fază.', angle: 'viitor relațional', motion: 2, active: true, weight: 9 },
  { id: 'preview-money-future-v1', kind: 'preview', label: 'Money Future', hypothesis: 'Graficul financiar arată sensul actual al liniei și maschează vârsta următorului viraj.', angle: 'viitor financiar', motion: 2, active: true, weight: 9 },
