...
@media (max-width:600px){.hero-video{width:min(78vw,330px);margin:18px auto 0;}.hero-video-frame{border-radius:10px;}.hero-video-caption{font-size:12px!important;line-height:1.4;}}
  #inputFormCard{max-width:920px;margin:28px auto 0;padding:0 28px 28px!important;overflow:hidden;border:1px solid rgba(212,175,55,.15);border-radius:2rem;background:linear-gradient(145deg,rgba(40,24,62,.72),rgba(13,13,35,.9))!important;box-shadow:0 24px 80px -40px rgba(212,175,55,.35);}
