...
rep('<div class="card" id="inputFormCard">',
  ...
  '        <p class="numerology-intro-detail">Характер, отношения, предназначение, реализация и важные периоды жизни — всё, что числа могут рассказать именно о тебе.</p>\n'
    ...
    '    </div>\n', 1)
rep('</head>', """<style>
.card#inputFormCard{box-sizing:border-box;position:relative;width:100%;max-width:none;overflow:hidden;border-radius:2rem;padding:0 22px 22px;background:linear-gradient(145deg,rgba(40,24,62,.72),rgba(13,13,35,.9));box-shadow:none!important;}.card#inputFormCard>.section-title{display:none!important;}.card#inputFormCard .section-title{display:none!important;}.card#inputFormCard>form,.card#inputFormCard>div:not(.numerology-intro){position:relative;z-index:3;}.numerology-intro{position:relative;isolation:isolate;max-width:none;min-height:250px;margin:0 -22px 8px;display:flex;align-items:center;justify-content:center;overflow:hidden;border:0!important;border-bottom:0!important;border-radius:2rem 2rem 0 0;background:radial-gradient(ellipse at 12% 18%,rgba(150,74,108,.34),transparent 34%),radial-gradient(ellipse at 88% 22%,rgba(82,70,143,.36),transparent 35%),radial-gradient(ellipse at 68% 92%,rgba(190,119,54,.2),transparent 36%),radial-gradient(ellipse at 30% 78%,rgba(77,104,157,.2),transparent 32%),linear-gradient(150deg,rgba(39,24,63,.9),rgba(13,13,35,.96));box-shadow:none!important;}.numerology-intro:before,.numerology-intro:after{content:"";position:absolute;inset:-24%;z-index:0;pointer-events:none;border-radius:50%;filter:blur(28px);opacity:.75;animation:numerologyNebula 18s ease-in-out infinite alternate;background:radial-gradient(ellipse at 22% 34%,rgba(213,116,137,.34),transparent 22%),radial-gradient(ellipse at 76% 30%,rgba(107,116,205,.3),transparent 24%),radial-gradient(ellipse at 62% 78%,rgba(224,169,83,.2),transparent 20%);}.numerology-intro:after{opacity:.5;filter:blur(42px);animation-duration:25s;animation-direction:alternate-reverse;background:radial-gradient(ellipse at 82% 68%,rgba(156,93,193,.35),transparent 24%),radial-gradient(ellipse at 18% 72%,rgba(67,133,174,.25),transparent 20%);}.numerology-intro > *{position:relative;z-index:1;}
...
@keyframes numerologyReveal{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:none}}@keyframes numerologyNebula{from{transform:translate3d(-3%,-2%,0) scale(1)}to{transform:translate3d(4%,3%,0) scale(1.08)}}@keyframes formNebulaDrift{from{transform:translate3d(-3%,-2%,0) scale(1)}to{transform:translate3d(3%,2%,0) scale(1.08)}}
...
@media (max-width:600px){.hero-video{width:min(78vw,330px);margin:18px auto 0;}.hero-video-frame{border-radius:10px;}.hero-video-caption{font-size:12px!important;line-height:1.4;}}
  #inputFormCard{box-sizing:border-box;display:block;width:100%;max-width:none;margin:0!important;padding:0 28px 18px!important;overflow:hidden;border:1px solid rgba(212,175,55,.2);border-radius:2rem;background:radial-gradient(ellipse at 8% 18%,rgba(160,76,112,.2),transparent 28%),radial-gradient(ellipse at 92% 30%,rgba(78,92,167,.22),transparent 30%),radial-gradient(ellipse at 52% 100%,rgba(192,126,55,.14),transparent 32%),linear-gradient(145deg,rgba(38,24,61,.94),rgba(10,11,29,.98))!important;box-shadow:0 24px 80px rgba(6,5,20,.45),inset 0 1px 0 rgba(255,255,255,.06),inset 0 0 80px rgba(105,61,139,.08);isolation:isolate;}#inputFormCard:before,#inputFormCard:after{content:"";position:absolute;z-index:0;inset:-20%;pointer-events:none;border-radius:50%;filter:blur(48px);opacity:.55;animation:formNebulaDrift 24s ease-in-out infinite alternate;background:radial-gradient(ellipse at 18% 26%,rgba(223,126,145,.24),transparent 19%),radial-gradient(ellipse at 78% 44%,rgba(103,126,211,.22),transparent 21%),radial-gradient(ellipse at 60% 84%,rgba(222,172,88,.16),transparent 18%);}#inputFormCard:after{opacity:.34;filter:blur(70px);animation-duration:32s;animation-direction:alternate-reverse;background:radial-gradient(ellipse at 86% 76%,rgba(167,101,204,.24),transparent 22%),radial-gradient(ellipse at 20% 66%,rgba(66,139,176,.18),transparent 20%);}#inputFormCard>form,#inputFormCard>.numerology-intro,#inputFormCard>div:not(.numerology-intro){position:relative;z-index:1;}
